...
def reset_and_set_commands():
    ...
    general_commands = [
        ...
        {"command": "json", "description": "🔄 JSON → .txt Link Converter"},
        {"command": "logs", "description": "👁️ View Bot Activity"},
        {"command": "history", "description": "📥 Tracked YT Download (auto-resume)"},
        ...
        {"command": "topicid", "description": "📌 Get Current Topic ID"},
    ]
